<template>
  <div class="hzzy-fa">
    ...
    <div v-for="(item, index) in commentList" class="hzzy-child" :key="index">
      <div class="reply"></div>
      <div class="content">
        <div class="comment-f">
        ...
        <div class="reply-content" :html="analyzeEmoji(item.content)">
        ...
        <div class="reply-content reply-fa">
          ...
          <div class="comment" :style="{ width: commentWidth }" v-if="replyMap[item.id]" :showAvatar="showAvatar">
            ...
            <div v-if="buttonMap[item.id]" class="hzzy-owo">
              ...
              <div class="publish publish-btn">
                <button class="btn" @click="doChidSend(item.id, item.commentUser, item.id)">发送</button>
          ...
          <div class="reply-content reply-fa">
            ...
            <div class="comment" :style="{ width: commentWidth }" v-if="replyMap[ritem.id]" :showAvatar="showAvatar">
              ...
              <div v-if="buttonMap[ritem.id]" class="hzzy-owo">
                ...
                <div class="publish publish-btn">
                  <button class="btn" @click="doChidSend(ritem.id, ritem.commentUser, item.id)">发送</button>
