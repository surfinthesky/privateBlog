  ...
  <div class="layout">
    <Layout>
      ...
      <!-- <Menu mode="horizontal" theme="dark" active-name="1">
          <div class="layout-logo">VueDemo</div>
      ...
      <Content :style="{ padding: '0 50px' }">
        ...
        <div id="basic_usage"  style="height:410px">Basic Usage</div>
        <div id="static_position" style="height:290px">Static Position</div>
        <div id="API">
          <ul>
            <li id="Anchor_props" style="height:460px">Anchor props</li>
            <li id="Anchor_events" style="height:360px">Anchor events</li>
            <li id="AnchorLink_props" style="height:160px">AnchorLink props</li>
          </ul>
        </div>
